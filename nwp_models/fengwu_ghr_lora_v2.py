...
from .lora import Linear_Lora_Groups, Linear_Head_Groups, Masked_Lora_Linear
...
class FengWu_GHR(BaseModel):
    ...
    def __init__(self, 
        ...
        if lora_name == 'Linear_Lora_Groups':
            ...
            raise ValueError(f"{lora_name} must be 'Linear_Lora_Groups or Linear_Head_Groups")
        ...
        # up
        self.down_linear = nn.Linear(self.embed_dim, 512, bias=False)
